...
@section('content')
    ...
    <div class="mx-3 body-min-height row">
            ...
            <div class="widget p-cb background-black-dark border-panel" style="height: 100%;">
                ...
                <div class="m-t-30">
                    <div class="form-group row">
                        ...
                        <div class="col-6"><h5 class="text-light">Balance</h5></div>
                    </div>
                    <div class="form-group row">
                        <div class="col-6"><img src="{{ asset('/icons/btc.svg') }}" width="32px" class="p-r-10"><b>BTC</b></div>
                        <div class="col-6"><h5 class="text-light">0.00300024</h5></div>
                    </div>
                    <div class="form-group row">
                        <div class="col-6"><img src="{{ asset('/icons/eth.svg') }}" width="32px" class="p-r-10"><b>ETH</b></div>
                        <div class="col-6"><h5 class="text-light">0.00300024</h5></div>
                    </div>
                    <div class="form-group row">
                        <div class="col-6"><img src="{{ asset('/icons/xrp.svg') }}" width="32px" class="p-r-10"><b>XRP</b></div>
                        <div class="col-6"><h5 class="text-light">0.00300024</h5></div>
                    </div>
                    <div class="form-group row">
                        <div class="col-6"><img src="{{ asset('/icons/ltc.svg') }}" width="32px" class="p-r-10"><b>LTC</b></div>
                        <div class="col-6"><h5 class="text-light">0.00300024</h5></div>
                    </div>
                    <div class="form-group row">
                        <div class="col-6"><img src="{{ asset('/icons/usdt.svg') }}" width="32px" class="p-r-10"><b>USDT</b></div>
                        <div class="col-6"><h5 class="text-light">0.00300024</h5></div>
                    </div>
                    <div class="form-group row">
                        <div class="col-6"><img src="{{ asset('/icons/ada.svg') }}" width="32px" class="p-r-10"><b>ADA</b></div>
                        <div class="col-6"><h5 class="text-light">0.00300024</h5></div>
                    </div>
                    <div class="form-group row">
                        <div class="col-6"><img src="{{ asset('/icons/wiz+.svg') }}" width="32px" class="p-r-10"><b>WIZ+</b></div>
                        <div class="col-6"><h5 class="text-light">0.00300024</h5></div>
                    </div>
                </div>
            </div>
