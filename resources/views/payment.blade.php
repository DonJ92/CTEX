            ...
            <div class="row">
                <div class="col-md-3 tab-border-right mb-3">
                    <ul class="nav flex-column nav-tabs border-1" id="myTab4" role="tablist" aria-orientation="vertical">
                        ...
                        <li class="nav-item">
                            <a class="nav-link no-border" id="eth-tab" data-bs-toggle="tab" href="#eth" role="tab" aria-controls="eth" aria-selected="false"><img src="{{ asset('/icons/xtz.svg') }}" width="32px" class="p-r-10"><b>XTZ</b></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link no-border" id="eth-tab" data-bs-toggle="tab" href="#eth" role="tab" aria-controls="eth" aria-selected="false"><img src="{{ asset('/icons/xlm.svg') }}" width="32px" class="p-r-10"><b>XLM</b></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link no-border" id="eth-tab" data-bs-toggle="tab" href="#eth" role="tab" aria-controls="eth" aria-selected="false"><img src="{{ asset('/icons/xem.svg') }}" width="32px" class="p-r-10"><b>XEM</b></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link no-border" id="eth-tab" data-bs-toggle="tab" href="#eth" role="tab" aria-controls="eth" aria-selected="false"><img src="{{ asset('/icons/etc.svg') }}" width="32px" class="p-r-10"><b>ETC</b></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link no-border" id="eth-tab" data-bs-toggle="tab" href="#eth" role="tab" aria-controls="eth" aria-selected="false"><img src="{{ asset('/icons/fil.svg') }}" width="32px" class="p-r-10"><b>FIL</b></a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-9">
